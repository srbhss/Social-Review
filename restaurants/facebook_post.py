...
class Facebook:
    ...
    def publish_photo_msg(self, message, image_url):
        host = 'https://graph.facebook.com' + "/" + str(self.page_id) + "/" + 'photos'
        data = {
            "url" : image_url,
            "message" : message,
            "access_token" : self.page_access_token
        }
        requests.post(url=host, data=data)
        return
...
if __name__ == '__main__':
    ...
    image_url = 'https://5.imimg.com/data5/TX/PO/MY-31939142/butterscotch-ice-cream-500x500.jpg'
    my_name = 'ss'
